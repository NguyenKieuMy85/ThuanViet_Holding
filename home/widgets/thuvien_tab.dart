...
class _ThuvienTabState extends State<ThuvienTab > {
  ...
  void initState() {
    super.initState();
    _videoController = VideoPlayerController.asset('assets/danko_city_video.mp4')
      ..initialize().then((_) {
        setState(() {});
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                _buildCategoryCard('Tất cả', 'assets/images/Tat_ca.png', Alignment.bottomLeft),
                _buildCategoryCard('Mới nhất', 'assets/images/Moi_nhat.png', Alignment.bottomLeft),
                _buildCategoryCard('Video', 'assets/images/Danko_city.png', Alignment.bottomLeft),
                _buildCategoryCard('Phòng', 'assets/images/phong.png', Alignment.bottomLeft),
              ],
            ),
          ),
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                } else if (item['type'] == 'video' && _videoController.value.isInitialized) {
                  return AspectRatio(
  ...
  Widget _buildCategoryCard(String title, String imagePath, Alignment textAlign) {
    return Expanded(
      child: InkWell(
        onTap: () {
          setState(() {
